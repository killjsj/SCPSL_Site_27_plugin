...
namespace AT4
{
    ...
    internal class AT4Item : CustomItem , IAT4API
    {
        ...
        public Pickup SpawnAT4( Vector3 pos )
        {
            ...
            if( AT4APIProvider.Instance.IsIntalized == false )
            {

                Log.Error("AT4插件未初始化，无法生成AT4！");
                return null;
